                        ...
                        if(args[1] == "minaf"){
                            if(flag == 1){
                                ...
                                if(zonas[linhaX][colunaX]->getSigla() == "mnt"){
                                    ...
                                    zonas[linhaX][colunaX]->setEdificio(new MinaFerro("minaf", (2 * custoMinaf * 10 - vigasMadeiraUsar * custoMinaf * 2)));
                                }
                                else{
                                ...
                                if(zonas[linhaX][colunaX]->getSigla() == "mnt"){
                                    ...
                                    zonas[linhaX][colunaX]->setEdificio(new MinaFerro("minaf", (2 * 100 - vigasMadeiraUsar * custoVigasMadeira * 2)));
                                }
                                else{
                            ...
                            if(flag == 1){
                                ...
                                if(zonas[linhaX][colunaX]->getSigla() == "mnt"){
                                    ...
                                    addSaldo(-(2 * custoMinaf * 10 - vigasMadeiraUsar * custoMinaf * 2));
                                    zonas[linhaX][colunaX]->setEdificio(new MinaCarvao("minac", (2 * custoMinaf * 10 - vigasMadeiraUsar * custoMinaf * 2)));
                                }
                                else{
                                    if (saldo - (custoMinaf * 10 - vigasMadeiraUsar * custoMinaf) < 0){
                                        cout << "Nao tem dinheiro suficiente. Faltam " << (custoMinaf * 10 - vigasMadeiraUsar * custoMinaf) << " euros!" << endl;
                                    ...
                                    addSaldo(-(custoMinaf * 10 - vigasMadeiraUsar * custoMinaf));
                                    zonas[linhaX][colunaX]->setEdificio(new MinaCarvao("minac", (custoMinaf * 10 - vigasMadeiraUsar * custoMinaf)));
                                }    
                            }
                            else{
                                do{
                                ...
                                if(zonas[linhaX][colunaX]->getSigla() == "mnt"){
                                    ...
                                    addSaldo(-(2 * 100 - vigasMadeiraUsar * custoVigasMadeira * 2));
                                    zonas[linhaX][colunaX]->setEdificio(new MinaCarvao("minac", (2 * 100 - vigasMadeiraUsar * custoVigasMadeira * 2)));
                                }
                                else{
                                    if(saldo - (100 - vigasMadeiraUsar * custoVigasMadeira) < 0){
                                        cout << "Nao tem dinheiro suficiente. Faltam " << (100 - vigasMadeiraUsar * custoVigasMadeira) << " euros!" << endl;
                            ...
                            if(zonas[linhaX][colunaX]->getSigla() == "mnt"){
                                ...
                                zonas[linhaX][colunaX]->setEdificio(new Central("central", custoCentral * 2));
                            }
                            else{
                            ...
                            if(zonas[linhaX][colunaX]->getSigla() == "mnt"){
                                ...
                                zonas[linhaX][colunaX]->setEdificio(new Bateria("bat", custoBateria * 2));
                            }
                            else{
                            ...
                            if(zonas[linhaX][colunaX]->getSigla() == "mnt"){
                                ...
                                zonas[linhaX][colunaX]->setEdificio(new Fundicao("fund", custoFundicao * 2));
                            }
                            else{
    ...
    for(int i = 0; i < linhas; i++){
        for(int j = 0; j < colunas; j++){    
            ...
            if(zonas[i][j]->getSigla() == "pas"){
                ...
                //FALTA FAZER A PARTE: MORRE ARVORE SE FOR CONSTRUIDO UM EDIFICIO NA ZONA
                //CRESCE 1 ARVORE A CADA DOIS DIAS QUE PASSAM (COM LIMITE DE 100 ARVORES NA ZONA)
